...
public:
	...
	virtual void learnNogoods(dlvhex::NogoodContainerPtr nogoods, std::vector<std::string> expressions,
			std::vector<dlvhex::ID> atomIds, GecodeSolver *solver) = 0;
};
...
public:
	...
	virtual void learnNogoods(dlvhex::NogoodContainerPtr nogoods, std::vector<std::string> expressions,
				std::vector<dlvhex::ID> atomIds, GecodeSolver *solver);
};
